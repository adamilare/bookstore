...
BOOKSTORE - A simple bookstore built with React and Redux.
...
- Listing of books; authour, titile, reading progress.
- Category listing of books.
...
```sh
  ...
  git clone https://github.com/adamilare/bookstore.git
```
...
I also acknowledge Usman Suleiman Babakolo.
